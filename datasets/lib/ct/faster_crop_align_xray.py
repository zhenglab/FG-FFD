...
class FasterCropAlignXRay:
    ...
    def __call__(self, landmarks68, five_landmarks, ori_boxes, images=None, jitter=False):
        ...
        transformed_landmarks5 = np.array(
            [transform_landmarks(ldm68, trans) for ldm68 in new_five_landmarks]
        )
        ...
        if images is not None:
            ...
            return transformed_landmarks68,transformed_landmarks5, transformed_images
        else:
            return transformed_landmarks68,transformed_landmarks5
