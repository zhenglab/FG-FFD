...
from .DeepFakeMask import dfl_full,facehull,components,extended,my_components_mask
import cv2
import tqdm
...
def random_get_hull_custom(landmark,img1,method='components',hull_type=None):
    if method == 'components':
        mask = my_components_mask(landmarks=landmark.astype('int32'),face=img1, channels=3,hull_type=hull_type).mask
        # print(mask.shape)
        return mask/255
    else:  # SBI mask
