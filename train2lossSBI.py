...
from engine_finetune import train_one_epoch, test_one_epoch, train_one_epoch2loss, train_one_epoch2loss_SBI,test_one_epoch_s1
args = get_params()
setup(args)
init_exam_dir(args)
###########################
...
def main():
    ...
    for epoch in range(start_epoch, num_epochs+1):
        ...
        train_one_epoch2loss_SBI(train_dataloader, model, criterion, optimizer, epoch, global_step, args, logger,lr_scheduler)
        global_step += len(train_dataloader)
        test_one_epoch_s1(model, criterion, optimizer, epoch, global_step, args, logger,lr_scheduler)
